...
class linearplot(object):
    def __init__(self, windowx = 600, windowy = 400, bordernorth = 50, bordersouth = 50, bordereast = 30, borderwest = 50, title = "Linear Plot",\
                 sortpoints = True, draw_lines = True, draw_points = False, ytitle = "", xtitle = "", line_color = "#0000bb", image = None,\
                 line_of_best_fit = False, line_of_best_fit_equation = False):
        ...
        self.line_of_best_fit_equation = line_of_best_fit_equation
...
#        elif self.sortpoints == False:
    ...
    def plot_data(self):
        ...
        print(self.xrangefactor, self.yrangefactor)
        ...
        print(n, sumx, sumy, sumxy, sumxsquared)
        ...
        print(self.bestfitslope, self.bestfitintercept)
        bestfitstart = [self.xrangemin, self.bestfitslope*self.xrangemin + self.bestfitintercept]
        bestfitend =  [self.xrangemax, self.bestfitslope*self.xrangemax + self.bestfitintercept]
        self.canvas.create_line((bestfitstart[0] - self.xrangemin)*(self.windowx - self.bordereast - self.borderwest)/(self.xrangemax - self.xrangemin) + self.borderwest,\
                                ...
                                (self.windowy - self.bordersouth) - (bestfitend[1] - self.yrangemin)*(self.windowy - self.bordernorth - self.bordersouth)/(self.yrangemax - self.yrangemin), fill = "#ffffff")
